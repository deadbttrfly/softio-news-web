  ...
  return (
    <div className="border-b border-line bg-paper py-5">
      <div className="mx-auto max-w-6xl px-4">
        ...
        {/* Filter Kategori (Rounded Pill Buttons) */}
        <div className="mt-4 flex flex-wrap gap-2">
          <button
            onClick={() => updateParams({ kategori: "" })}
            className={`px-3 py-1.5 text-xs font-mono uppercase tracking-widest2 border rounded-[90px] transition-colors ${
              activeCategory === ""
                ? "bg-white/40 text-paper border-ink"
                : "border-line text-slate-soft hover:bg-white/5"
            }`}
          >
            Semua
          </button>
