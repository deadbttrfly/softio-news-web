      ...
      {hasMore && (
        <div className="mt-12 flex justify-center">
          <button
            ...
            className="group inline-flex items-center gap-2 rounded-xl border border-white/10 bg-slate-900 px-6 py-3 text-sm font-semibold text-slate-200 shadow-xl transition-all duration-300 hover:border-indigo-500/50 hover:bg-slate-800/80 hover:text-white hover:shadow-indigo-500/10 active:scale-95"
          >
